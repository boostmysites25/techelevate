        ...
        <div className="wrapper absolute w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[2] flex flex-col-reverse gap-5 sm:grid grid-cols-[1fr,20%] items-center">
          <div data-aos="fade-up" className="max-w-[50rem] space-y-1">
            ...
            <h1 className="text_xl">
              Your Strategic <br /> Partner to <br />
              <span className="text-primary">INNOVATE HIGH</span>
            </h1>
            <p className="desc !text-xl">
              Elevating Standards, Engineering the Future
            </p>
      ...
      <section className="wrapper">
        ...
        >
          ...
          <div className="2xl:absolute right-0 top-1/2 2xl:-translate-y-1/2 p-5 2xl:px-10 2xl:w-2/5">
            ...
            >
              <b className="text-white">TECH ELEVATE</b> empowers
      ...
      <section className="pb-14 wrapper space-y-3">
        ...
        <div className="grid md:grid-cols-[40%,1fr] gap-10">
          ...
          <div data-aos="fade-up" className="space-y-3">
            <h2 className="text1">
              Elevating Businesses to New Heights of Innovation
            </h2>
            <p className="desc text-white/70">
              At TECH ELEVATE, we don't just build software; we architect the future.
              Our mission is to help you <b>INNOVATE HIGH</b> by delivering secure,
              scalable, and transformative technology solutions. Whether it's
              crafting immersive mobile experiences, deploying advanced AI, or
              building robust web platforms, we empower your business to rise above
              the competition in a rapidly evolving digital landscape.
            </p>
