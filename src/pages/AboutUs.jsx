        ...
        <div className="wrapper grid lg:grid-cols-[40%_1fr] items-center gap-10 text-grayClr z-10 relative">
          ...
          <div className="space-y-4">
            ...
            <p data-aos="fade-up" className="desc text-white/70">
              TECH ELEVATE is more than just a technology company — we
              ...
              <br />
              At TECH ELEVATE, we combine deep technical expertise with
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7 md:gap-16">
          <div data-aos="fade-up" className="space-y-4">
            ...
            <p className="desc !text-white">
              Our mission is to help businesses <b>INNOVATE HIGH</b>. We are committed to
        ...
        <div className="grid md:grid-cols-2 gap-7 md:gap-14">
          ...
          <div className="space-y-3">
            ...
            <p className="desc">
              ...
              TECH ELEVATE exists to fill that role — to provide
              ...
              TECH ELEVATE is here to deliver solutions that
