          ...
          <div data-aos="fade-up" className="max-w-[45rem] space-y-1">
            ...
            <h1 className="text_xl">
              ...
              <span className="text-primary">
                {isWeb ? "Future-Ready Web Solutions" : "Next-Gen Mobile Apps"}
              </span>
            </h1>
            <p className="desc">
              {isWeb
                ? "We architect digital experiences that captivate, convert, and scale."
                : "Building intuitive, high-performance apps that put your business in your customers' hands."}
            </p>
      ...
      <section className="wrapper">
        ...
        >
          ...
          <div className="2xl:absolute right-0 top-1/2 2xl:-translate-y-1/2 p-5 2xl:px-10 2xl:w-2/5">
            ...
            >
              <b className="text-white">TECH ELEVATE</b> drives
              digital transformation with{" "}
              {isWeb
                ? "web solutions that merge aesthetics with powerful functionality."
                : "mobile experiences that set new industry standards."}{" "}
              From bespoke {isWeb ? "web architectures" : "app ecosystems"} to
              intelligent automation, we help you <b>INNOVATE HIGH</b>.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-[40%,1fr] gap-7">
          ...
          <div data-aos="fade-up" className="space-y-3">
            ...
            <p className="desc text-white/70">
              At TECH ELEVATE, our mission is to push the boundaries of what technology can achieve.
              Whether we are{" "}
              {isWeb
                ? "redefining your web presence with immersive designs and robust backends,"
                : "engineering mobile applications that dominate app stores,"}
              integrating AI, or securing your infrastructure with blockchain,
              we are your partners in growth. We turn ambitious concepts into
